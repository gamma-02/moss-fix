...
public class MossMixin {
    ...
    public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state){
        MossFix.MOSS_PATCH_FEATURE.generate(new FeatureContext(Optional.empty(), world, world.getChunkManager().getChunkGenerator(), random, pos.up(), ConfiguredFeatures.MOSS_PATCH_BONEMEAL.getConfig()));
